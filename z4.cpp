...
int main() {
    ...
    t2=dodajElementeUAVLStabloMapa(nMapa);
    v1=clock();
    bMapa[100001]=1;
    v2=clock();
    ...
    v2=clock();
    tuk=(v2-v1)/(CLOCKS_PER_SEC/100000);
    std::cout<<"Vrijeme dodavanja novog elementa u AVLStabloMapa-u : "<<tuk<<" ms(/100)\n";
    ...
    v2=clock();
    tuk=(v2-v1)/(CLOCKS_PER_SEC/100000);
    std::cout<<"Vrijeme trazenja novog elementa u AVLStabloMapa-i: "<<tuk<<" ms(/100)\n";
    return 0;
}
